...
function get_contact_data()
{
	...
	dt.md='contact'
	var url='http://gallifrey:5001/cssadvjs?md=contact&uid='+dt.uid;
	...
	*/
		...
		$.post(doAction+"4",addFormData,function(data){
			if(data=="1"){// if the upload is successful
				$.getJSON("http://gallifrey:5001/cssadvjs?md=fbdone&uid="+uid,function(json){
					console.log(json.fb);			
				})
...
{
	$.getJSON("http://gallifrey:5001/cssadvjs?md=fbremove&uid="+uid,function(json){
